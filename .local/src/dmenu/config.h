...
static Key keys[] = {
	...
	{ MODKEY,			XK_c,		spawn,		SHCMD("setxkbmap me") },
	{ MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("setxkbmap rs") },
	...
	{ MODKEY,			XK_F5,		spawn,		SHCMD("xtrlock") },
	...
	{ MODKEY,			XK_F12,		spawn,		SHCMD("setxkbmap us") },
